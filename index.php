  <?php 
  /* Nom : index.php
   * Description : Page principale du site où se situent le header, le footer ainsi que des includes vers toutes les autres pages du site.
   * Pages appelées : Toutes les pages du site, celles de connexion à la BDD, de CSS et de javascript  
   */
  session_start(); 
  ?>
  <!DOCTYPE html>
  ...
  ?>
     ...
     <div class="container">
        <div class="header"> <!-- header conenant le menu du site -->
          ...
          <div class="form-group col-lg-12 cadre_logo">
           ...
           <!-- Test pour vérfier si l'utlisateur est connecté au site -->
            <?php if (!(isset($_SESSION['idU']))){?> <!-- Cas d'un visiteur -->   
            ...
            <!-- </ul> -->
              <?php }else{ ?> <!-- Cas où l est connecté -->
  ...
  <!-- ___________________________________________________________________________________________________________________________________________________ -->
         <?php 
         /* C'est ici que les pages sont appelées en fonction de la valeur de la variable 'p'
          * Seul le contenue de la page sera rehcargé, le reste sera inchangé.
         */
          if(empty($_GET['p']))
  ...
  <!-- ___________________________________________________________________________________________________________________________________________________ -->
    ...
    <!-- Pied de page -->
        <footer class="footer">
          <p>&copy; STRI 2015 </p>
            <p><a href="?p=faq">FAQ </a> | <a href="?p=qsn">Qui sommes-nous? </a> | <a href="?p=contact">Nous contacter </a>  | <a href="?p=admin">Admin </a> </p>
